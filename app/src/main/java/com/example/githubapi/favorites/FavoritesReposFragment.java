...
public class FavoritesReposFragment extends Fragment implements TrendingAdapter.OnItemClickListener {
    ...
    public void onItemClick(int pos, Item item) {
        FavoritesReposFragmentDirections.ActionFavoritesRepoFragmentToRepoDetailFragment action = FavoritesReposFragmentDirections.actionFavoritesRepoFragmentToRepoDetailFragment(item.getId());
